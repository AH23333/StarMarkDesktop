...
[tests/StarMark.SmokeTest/Program.cs](../tests/StarMark.SmokeTest/Program.cs) 提供双模式：
...
3. **托盘常驻 + 全局热键** — MVP Phase 1 单窗口已可用，但缺少"随时呼出"能力，与浏览器扩展体验差距明显
